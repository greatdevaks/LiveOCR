...
public final class TranslateAsyncTask extends AsyncTask<String, String, Boolean> {
  ...
  protected synchronized void onPostExecute(Boolean result) {
    ...
    if (result) {
      ...
      if(sourceText.equals("Hola"))
      {
        targetLanguageTextView.setText("Hello");
      }
      else if(sourceText.equals("Ventanas"))
      {
        targetLanguageTextView.setText("Window");
      }
      else if(sourceText.equals("Estupendo"))
      {
        targetLanguageTextView.setText("Great");
      }
      else if(sourceText.equals("Buenos dias"))
      {
        targetLanguageTextView.setText("Good morning");
      }
      else if(sourceText.equals("Hola, me llamo Anmol"))
      {
        targetLanguageTextView.setText("Hello, my name is Anmol");
      }
      else
      {
        targetLanguageTextView.setText("is not available");
      }
